...
var require_module_cjs = __commonJS({
  "node_modules/alpinejs/dist/module.cjs.js"(exports) {
    ...
    var require_shared = __commonJS2((exports2, module22) => {
      "use strict";
      if (false) {
        module22.exports = null;
      } else {
        module22.exports = require_shared_cjs();
      }
    });
    ...
    var require_reactivity = __commonJS2((exports2, module22) => {
      "use strict";
      if (false) {
        module22.exports = null;
      } else {
        module22.exports = require_reactivity_cjs();
      }
    });
    ...
    function addScopeToNode2(node, data2, referenceNode) {
...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
    ...
    function start() {
      ...
      startObservingMutations();
      onElAdded((el) => initTree2(el, walk));
    ...
    function initTree2(el, walker = walk) {
    ...
    directive("model", (el, { modifiers, expression }, { effect: effect3, cleanup }) => {
      ...
      el._x_forceModelUpdate = () => {
        evaluate2((value) => {
          ...
          mutateDom2(() => bind(el, "value", value));
    ...
    directive("cloak", (el) => queueMicrotask(() => mutateDom2(() => el.removeAttribute(prefix("cloak")))));
    ...
    directive("bind", (el, { value, modifiers, expression, original }, { effect: effect3 }) => {
      ...
      effect3(() => evaluate2((result) => {
        if (result === void 0 && expression.match(/\./))
          result = "";
        mutateDom2(() => bind(el, value, result, modifiers));
      }));
    });
    ...
    function loop(el, iteratorNames, evaluateItems, evaluateKey) {
      ...
      evaluateItems((items) => {
        ...
        for (let i = 0; i < adds.length; i++) {
          ...
          addScopeToNode2(clone2, reactive(scope2), templateEl);
          mutateDom2(() => {
            lastEl.after(clone2);
            initTree2(clone2);
          });
...
var initTree = import_alpinejs.default.initTree;
var mutateDom = import_alpinejs.default.mutateDom;
var addScopeToNode = import_alpinejs.default.addScopeToNode;
var warn = import_alpinejs.default.warn;
function src_default(Alpine2) {
  Alpine2.directive("teleport2", teleport);
